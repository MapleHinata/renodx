// ---- Created with 3Dmigoto v1.4.1 on Wed Nov  5 02:05:01 2025
// Used by the game during the splash screen, logos and patching scenes.
// Doesn't do tonemapping at the end, and since it's only used on 2D scenes, it's here just for completeness sake.
#include "../../shared.h"
...
void main(
  ...
  float3 tonemapped = renodx::draw::ToneMapPass(untonemapped);  // lmao no tonemapping.
