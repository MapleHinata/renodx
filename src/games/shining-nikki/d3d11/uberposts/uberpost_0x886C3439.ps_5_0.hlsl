...
/* Main uberpost, has a custom Bloom implementation plus code for an additional SDR lut (Never seems to be called.)
Used in the main menu and most 3D scenes in the game.*/
#include "../../shared.h"
...
cbuffer _Globals : register(b0) {
  ...
  float4 __Bloom_Params : packoffset(c3);
  float __Bloom_RGBM : packoffset(c4);
  float4 __Vignette_Params1 : packoffset(c5);
  float4 __Vignette_Params2 : packoffset(c6);
  float __EnableAlpha : packoffset(c7);
  float __BloomMaskEnable : packoffset(c8);
  float __UseCustomAlpha : packoffset(c9);
  float4 __OutlineParams : packoffset(c10);
  float4 __Outline3Params : packoffset(c11);
  float4 __OutlineColor : packoffset(c12);
}
...
void main(
  ...
  if (r0.z != 0) {
    r1.w = textures2D_4_.Sample(samplers2D_4__s, v2.xy).x;
    r1.w = r1.w;
    r1.w = r1.w;
  } else {
    r1.w = r1.w;
  }
  r2.xyzw = textures2D_1_.Sample(samplers2D_1__s, v2.xy).xyzw;
  r2.xyzw = r2.xyzw;
  r0.z = cmp(0 < __Bloom_RGBM);
  if (r0.z != 0) {
  ...
  r0.z = -__BloomMaskEnable;
  r0.z = 1 + r0.z;
  r0.w = __BloomMaskEnable * r1.w;
  r0.z = r0.w + r0.z;
  r3.xyz = __Bloom_Params.xxx * r0.zzz;
  r3.xyz = r3.xyz;
  r3.xyz = r3.xyz;
  r2.xyz = r3.xyz * r2.xyz;
  r2.xyz = __Bloom_Params.yzw * r2.xyz;
  ...
  if (r0.z != 0) {
    ...
    if (r0.z != 0) {
      ...
      r3.x = r3.y * r3.x;
      r3.y = r3.x * r3.x;
      r3.z = 0.0208350997 * r3.y;
      r3.z = -0.0851330012 + r3.z;
      r3.z = r3.y * r3.z;
      r3.z = 0.180141002 + r3.z;
      r3.z = r3.y * r3.z;
      r3.z = -0.330299497 + r3.z;
      r3.y = r3.y * r3.z;
      r3.y = 0.999866009 + r3.y;
      r3.z = r3.y * r3.x;
      r3.w = -r2.w;
      r3.w = max(r3.w, r2.w);
      r3.w = cmp(1 < r3.w);
      ...
      r3.x = r3.x;
      r3.y = 0.5;
      r0.z = textures2D_5_.Sample(samplers2D_5__s, r3.xy).x;
      r0.z = r0.z;
      r0.z = r0.z;
    } else {
      r0.z = 1;
    ...
    r0.zw = r0.zw;
    r0.zw = r0.zw;
    r3.yz = r0.zw / __ScreenParams.yx;
    r3.xw = -r3.zy;
    r4.xyzw = r3.xyzw + r0.xyxy;
    r4.xy = r4.xy;
    r0.z = textures2D_4_.Sample(samplers2D_4__s, r4.xy).x;
    r0.z = r0.z;
    r0.z = r0.z;
    ...
    r0.z = r0.z;
    r4.zw = r4.zw;
    r0.w = textures2D_4_.Sample(samplers2D_4__s, r4.zw).x;
    r0.w = r0.w;
    r0.w = r0.w;
    ...
    r3.xw = r3.xw + r0.xy;
    r3.xw = r3.xw;
    r2.w = textures2D_4_.Sample(samplers2D_4__s, r3.xw).x;
    r2.w = r2.w;
    r2.w = cmp(r2.w >= 0.0500000007);
    r3.xy = r3.zy + r0.xy;
    r3.xy = r3.xy;
    r3.x = textures2D_4_.Sample(samplers2D_4__s, r3.xy).x;
    r3.x = r3.x;
    r3.x = r3.x;
    r3.x = cmp(r3.x >= 0.0500000007);
    if (r3.x != 0) {
      r3.x = 1;
    } else {
      r3.x = 0;
    ...
    r0.z = r0.z + r0.w;
    r0.z = sqrt(r0.z);
    r0.w = textures2D_4_.Sample(samplers2D_4__s, v2.xy).x;
    r0.w = r0.w;
    r0.w = r0.w;
    ...
    r0.z = r0.z;
    r2.w = cmp(0.00999999978 < __UseCustomAlpha);
    ...
    r3.xyz = r3.xyz;
    r4.xyz = __OutlineColor.xyz * r3.xyz;
    r5.xyz = -__OutlineColor.xyz;
    r3.xyz = r5.xyz * r3.xyz;
    r3.xyz = r3.xyz + r2.xyz;
    r3.xyz = __OutlineParams.yyy * r3.xyz;
  ...
  r0.xyz = __Lut_Params.www * r2.zxy;
  ...
  r2.y = r2.y;
  r0.z = 0;
  r3.xyz = textures2D_2_.SampleLevel(samplers2D_2__s, r2.xy, r0.z).xyz;
  r3.xyz = r3.xyz;
  r3.xyz = r3.xyz;
  r4.x = __Lut_Params.y;
  r4.y = 0;
  ...
  r0.zw = r0.zw;
  r2.x = 0;
  r2.xyz = textures2D_2_.SampleLevel(samplers2D_2__s, r0.zw, r2.x).xyz;
  r2.xyz = r2.xyz;
  ...
  if (r0.w != 0) {
    ...
    r2.y = r2.y;
    r2.z = 0;
    r3.xyz = textures2D_3_.SampleLevel(samplers2D_3__s, r2.xy, r2.z).xyz;
    r3.xyz = r3.xyz;
    ...
    r2.xy = r2.xy;
    r2.z = 0;
    r2.xyz = textures2D_3_.SampleLevel(samplers2D_3__s, r2.xy, r2.z).xyz;
    r2.xyz = r2.xyz;
