#ifndef SRC_HL2_SHARED_H_
#define SRC_HL2_SHARED_H_
...
#define RENODX_SWAP_CHAIN_CUSTOM_COLOR_SPACE          shader_injection[5][1]
#define RENODX_SWAP_CHAIN_CLAMP_COLOR_SPACE           shader_injection[5][2]
